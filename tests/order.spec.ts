 ...
 * Tests positive and negative scenarios for placing orders
...
test.describe('Order Placement Flow', () => {
    ...
    test.beforeAll(async () => {
        Logger.initialize();
        Logger.info('=== Order Placement Test Suite Started ===');
    ...
    // Log after all tests
    test.afterAll(async () => {
        Logger.info('=== Order Placement Test Suite Completed ===');
